...
public class CommissionEmployee2 {
    ...
    public CommissionEmployee2(String first, String last, String ssn, double sales, double rate) { //комиссионный работник, имя, фамилию,ssn, ставку комиссии и валовую (т. е. общую) сумму продаж.
...
//    }
    ...
    public static void main(String[] args) {
        ...
        CommissionEmployee employee = new CommissionEmployee("<Bob>", "Lewis", "333-33-3333", 5000, 0.04);
