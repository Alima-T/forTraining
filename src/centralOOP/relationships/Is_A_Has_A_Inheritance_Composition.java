...
public class Is_A_Has_A_Inheritance_Composition {
 ...
 /*   Inheritance (IS-A) vs. Composition (HAS-A) Relationship
    ...
    HAS-A Relationship:
    Composition(HAS-A) simply mean the use of instance variables (экземпляр переменной) that are references to other objects.
